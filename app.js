// Defensive coding to ensure libraries are loaded
(function() {
    // Check if required libraries are loaded
    if (typeof React === 'undefined' || 
        typeof ReactDOM === 'undefined' || 
        typeof Recharts === 'undefined') {
        console.error('Critical libraries not loaded. Please check your script imports.');
        return;
    }

    // Destructure React and Recharts safely
